...
public class CopyOnWriteArraySetExamples {
    public static void main(String... args) throws NoSuchFieldException, IllegalAccessException {
        ...
        // The uniqueness is dependent on equals method for Student class.
        ...
        for (int size = 1_000; size <= 128_000; size *= 2) {
            ...
            try {
                // Creating this object would take quadratic time complexity
                // This can be used when the number of elements will be 10-100 max.
